...
print 'some_method was called: %r' % (mocked_obj.some_method.called, )
...
mocked_obj.some_method('here', 'are', some='arguments')
mocked_obj.some_method.assert_called_with('here', 'are', some='arguments')

# get the arguments that the method was called with
print 'some_method was called with %r' % (mocked_obj.some_method.call_args, )

# invalid argument assertion throws the proper exception
try:
    mocked_obj.some_method.assert_called_with('other' 'arguments')
except AssertionError:
    print 'some_method was not called with those arguments'

# get the number of times the method was called
mocked_obj.some_method('other', 'arguments')
print 'some_method has been called %s times' % (mocked_obj.some_method.call_count, )
